      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="text-center md:text-left">
            <span className="font-display text-3xl font-bold gradient-text">MA</span>
        ...
        <div className="mt-10 pt-8 border-t border-white/[0.05] flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="font-body text-white/20 text-xs">
            © {year} Maqdad Ali. All rights reserved.
          </p>
          <p className="font-mono text-white/15 text-xs">
